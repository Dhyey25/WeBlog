...
const register = async (req: Request, res: Response) => {
    ...
    await SendMail({
        ...
        to: email,
        subject: "WeBlog: Email Verification",
        text: `Thank you for registering with WeBlog! Your OTP (One-Time Password) is ${otpCode}. Please use this code to verify your email.`,
        html: `<h1>Thank you for registering with WeBlog!</h1><p>Your OTP (One-Time Password) is <strong>${otpCode}</strong>. Please use this code to verify your email.</p>`,
    })
